...
ALTER TABLE T_CKP_LIVRO ADD CONSTRAINT FK_CKP_LIVRO_CATEGORIA FOREIGN KEY (CD_CATEGORIA)
...
ALTER TABLE T_CKP_AUTOR_LIVRO ADD CONSTRAINT FK_CKP_AUTOR_LIVRO FOREIGN KEY (NR_ISBN)
REFERENCES T_CKP_LIVRO(NR_ISBN);
